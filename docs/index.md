...
* [Developer documentation](developer/gettingstarted/README.md) - building, configuring and extending Kitodo.Production
* [User documentation](user/introduction/using.md) - using Kitodo.Production

## Further resources

* [Project repository](https://github.com/kitodo/kitodo-production)
* [Javadoc](developer/javadoc/README.md)
* [Mailing lists](https://maillist.slub-dresden.de/cgi-bin/mailman/listinfo/kitodo-developer) - contact the developer team if specific questions are not covered here yet
